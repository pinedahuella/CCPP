...
px(f48,15,16,HAB2); px(f48,16,16,SKNS)
...
px(f49,3,15,HAB1); px(f49,3,14,HAB1); px(f49,2,13,HAB1)
px(f49,2,12,HAB1); px(f49,1,11,HAB2); px(f49,0,10,SKNS); px(f49,0,9,SKIN)
px(f49,14,15,HAB1); px(f49,14,14,HAB1); px(f49,15,13,HAB1)
px(f49,15,12,HAB1); px(f49,16,11,HAB2); px(f49,17,10,SKNS); px(f49,17,9,SKIN)
...
px(_f48m1,15,16,_ms2); px(_f48m1,16,16,SKNS)
...
px(_f49m1,3,15,_ms1); px(_f49m1,3,14,_ms1); px(_f49m1,2,13,_ms1)
px(_f49m1,2,12,_ms1); px(_f49m1,1,11,_ms2); px(_f49m1,0,10,SKNS); px(_f49m1,0,9,SKIN)
px(_f49m1,14,15,_ms1); px(_f49m1,14,14,_ms1); px(_f49m1,15,13,_ms1)
px(_f49m1,15,12,_ms1); px(_f49m1,16,11,_ms2); px(_f49m1,17,10,SKNS); px(_f49m1,17,9,SKIN)
